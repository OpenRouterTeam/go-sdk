...
func (s *Datasets) GetAppRankings(ctx context.Context, request *operations.GetAppRankingsRequest, opts ...operations.Option) (*operations.GetAppRankingsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AppRankingsResponse
...
func (s *Datasets) GetBenchmarksArtificialAnalysis(ctx context.Context, maxResults *int64, opts ...operations.Option) (*components.BenchmarksAAResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/datasets/benchmarks/artificial-analysis")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.BenchmarksAAResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Datasets) GetBenchmarksDesignArena(ctx context.Context, arena *operations.Arena, category *string, maxResults *int64, opts ...operations.Option) (*components.BenchmarksDAResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/datasets/benchmarks/design-arena")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.BenchmarksDAResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Datasets) GetRankingsDaily(ctx context.Context, startDate *string, endDate *string, opts ...operations.Option) (*components.RankingsDailyResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.RankingsDailyResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
