...
| `request`                                                                              | [components.ImageGenerationRequest](../../models/components/imagegenerationrequest) | :heavy_check_mark:                                                                     | The request object to use for the request.                                             |
| `opts`                                                                                 | [][operations.Option](../../models/operations/option)                               | :heavy_minus_sign:                                                                     | The options for this request.                                                          |

### Response

**[*operations.CreateImagesResponse](../../models/operations/createimagesresponse), error**
...
**[*components.ImageModelsListResponse](../../models/components/imagemodelslistresponse), error**
...
**[*components.ImageModelEndpointsResponse](../../models/components/imagemodelendpointsresponse), error**
