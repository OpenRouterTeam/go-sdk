...
<!-- UsageSnippet language="go" operationID="getBenchmarks" method="get" path="/benchmarks" -->
```go
package main
...
**[*components.UnifiedBenchmarksResponse](../../models/components/unifiedbenchmarksresponse.md), error**
