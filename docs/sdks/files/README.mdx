...
**[*operations.ListFilesResponse](../../models/operations/listfilesresponse), error**
...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| `ctx`                                                                                                        | [context.Context](https://pkg.go.dev/context#Context)                                                        | :heavy_check_mark:                                                                                           | The context to use for the request.                                                                          |                                                                                                              |
| `requestBody`                                                                                                | [operations.UploadFileRequestBody](../../models/operations/uploadfilerequestbody)                         | :heavy_check_mark:                                                                                           | N/A                                                                                                          |                                                                                                              |
...
**[*components.FileResponse](../../models/components/fileresponse), error**
...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| `ctx`                                                                                                        | [context.Context](https://pkg.go.dev/context#Context)                                                        | :heavy_check_mark:                                                                                           | The context to use for the request.                                                                          |                                                                                                              |
| `fileID`                                                                                                     | `string`                                                                                                     | :heavy_check_mark:                                                                                           | N/A                                                                                                          | or_file_011CNha8iCJcU1wXNR6q4V8w                                                                             |
| `workspaceID`                                                                                                | `*string`                                                                                                    | :heavy_minus_sign:                                                                                           | Workspace to scope the request to. Defaults to the caller’s default workspace.                               | a103d8b6-42f0-4e50-9a3c-bf41e2c3c1a7                                                                         |
| `provider`                                                                                                   | [*components.FileProvider](../../models/components/fileprovider)                                          | :heavy_minus_sign:                                                                                           | Store or read this file on the named provider using your own API key for it. Omit to use OpenRouter storage. | openai                                                                                                       |
| `opts`                                                                                                       | [][operations.Option](../../models/operations/option)                                                     | :heavy_minus_sign:                                                                                           | The options for this request.                                                                                |                                                                                                              |
...
**[*components.FileDeleteResponse](../../models/components/filedeleteresponse), error**
