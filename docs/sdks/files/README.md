...
<!-- UsageSnippet language="go" operationID="listFiles" method="get" path="/files" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="uploadFile" method="post" path="/files" -->
```go
package main
...
**[*components.FileMetadata](../../models/components/filemetadata.md), error**
...
<!-- UsageSnippet language="go" operationID="deleteFile" method="delete" path="/files/{file_id}" -->
```go
package main
...
**[*components.FileDeleteResponse](../../models/components/filedeleteresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getFileMetadata" method="get" path="/files/{file_id}" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="downloadFileContent" method="get" path="/files/{file_id}/content" -->
```go
package main
