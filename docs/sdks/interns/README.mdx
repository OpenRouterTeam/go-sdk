...
func main() {
    ...
    res, err := s.Interns.GetInternDaemonAccess(ctx, "7c9e6679-7425-40de-944b-e07fc1f90ae7")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
**[*components.InternDaemonAccess](../../models/components/interndaemonaccess.mdx), error**

### Errors

| Error Type                     | Status Code                    | Content Type                   |
| ------------------------------ | ------------------------------ | ------------------------------ |
| sdkerrors.InternLifecycleError | 401, 403, 404, 408, 409, 429   | application/json               |
| sdkerrors.InternLifecycleError | 500                            | application/json               |
| sdkerrors.APIError             | 4XX, 5XX                       | \*/\*                          |
...
func main() {
    ...
    res, err := s.Interns.Invoke(ctx, "a11e0000-0000-4000-8000-000000000005", components.InternInvokeRequest{
...
**[*operations.InvokeInternResponse](../../models/operations/invokeinternresponse.mdx), error**

### Errors

| Error Type                        | Status Code                       | Content Type                      |
| --------------------------------- | --------------------------------- | --------------------------------- |
| sdkerrors.InternChatErrorResponse | 400, 401, 403, 404, 408, 413      | application/json                  |
| sdkerrors.InternChatErrorResponse | 409, 429                          | application/json                  |
| sdkerrors.InternChatErrorResponse | 503                               | application/json                  |
| sdkerrors.InternChatErrorResponse | 500, 502, 504                     | application/json                  |
| sdkerrors.APIError                | 4XX, 5XX                          | \*/\*                             |