...
**[*operations.GetAppRankingsResponse](../../models/operations/getapprankingsresponse), error**
...
**[*components.RankingsDailyResponse](../../models/components/rankingsdailyresponse), error**
