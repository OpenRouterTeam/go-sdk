...
**[*operations.GetAnalyticsMetaResponse](../../models/operations/getanalyticsmetaresponse), error**
...
**[*operations.QueryAnalyticsResponse](../../models/operations/queryanalyticsresponse), error**
