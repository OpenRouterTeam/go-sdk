...
func main() {
    ...
    res, err := s.Generations.SubmitFeedback(ctx, components.SubmitGenerationFeedbackRequest{
        Category: components.SubmitGenerationFeedbackRequestCategoryIncorrectResponse,
...
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                    | [context.Context](https://pkg.go.dev/context#Context)                                                    | :heavy_check_mark:                                                                                       | The context to use for the request.                                                                      |
| `request`                                                                                                | [components.SubmitGenerationFeedbackRequest](../../models/components/submitgenerationfeedbackrequest.mdx) | :heavy_check_mark:                                                                                       | The request object to use for the request.                                                               |
| `opts`                                                                                                   | [][operations.Option](../../models/operations/option.mdx)                                                 | :heavy_minus_sign:                                                                                       | The options for this request.                                                                            |
