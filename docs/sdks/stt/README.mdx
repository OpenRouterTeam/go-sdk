...
| `request`                                                      | [components.STTRequest](../../models/components/sttrequest) | :heavy_check_mark:                                             | The request object to use for the request.                     |
| `opts`                                                         | [][operations.Option](../../models/operations/option)       | :heavy_minus_sign:                                             | The options for this request.                                  |

### Response

**[*components.STTResponse](../../models/components/sttresponse), error**
