...
| `provider`                                                                                    | [*operations.Provider](../../models/operations/provider)                                   | :heavy_minus_sign:                                                                            | Optional provider slug to filter by (e.g. `openai`, `anthropic`, `amazon-bedrock`).           | openai                                                                                        |
| `opts`                                                                                        | [][operations.Option](../../models/operations/option)                                      | :heavy_minus_sign:                                                                            | The options for this request.                                                                 |                                                                                               |

### Response

**[*operations.ListBYOKKeysResponse](../../models/operations/listbyokkeysresponse), error**
...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `ctx`                                                                              | [context.Context](https://pkg.go.dev/context#Context)                              | :heavy_check_mark:                                                                 | The context to use for the request.                                                |
| `request`                                                                          | [components.CreateBYOKKeyRequest](../../models/components/createbyokkeyrequest) | :heavy_check_mark:                                                                 | The request object to use for the request.                                         |
| `opts`                                                                             | [][operations.Option](../../models/operations/option)                           | :heavy_minus_sign:                                                                 | The options for this request.                                                      |

### Response

**[*components.CreateBYOKKeyResponse](../../models/components/createbyokkeyresponse), error**
...
**[*components.DeleteBYOKKeyResponse](../../models/components/deletebyokkeyresponse), error**
...
**[*components.GetBYOKKeyResponse](../../models/components/getbyokkeyresponse), error**
...
| `ctx`                                                                              | [context.Context](https://pkg.go.dev/context#Context)                              | :heavy_check_mark:                                                                 | The context to use for the request.                                                |                                                                                    |
| `id`                                                                               | `string`                                                                           | :heavy_check_mark:                                                                 | The BYOK credential ID (UUID).                                                     | 11111111-2222-3333-4444-555555555555                                               |
| `updateBYOKKeyRequest`                                                             | [components.UpdateBYOKKeyRequest](../../models/components/updatebyokkeyrequest) | :heavy_check_mark:                                                                 | N/A                                                                                | \{<br/>"disabled": false,<br/>"name": "Updated OpenAI Key"<br/>}                    |
| `opts`                                                                             | [][operations.Option](../../models/operations/option)                           | :heavy_minus_sign:                                                                 | The options for this request.                                                      |                                                                                    |

### Response

**[*components.UpdateBYOKKeyResponse](../../models/components/updatebyokkeyresponse), error**
