...
| `requestBody`                                                                                                             | [operations.UpdateKeysRequestBody](../../models/operations/updatekeysrequestbody.mdx)                                      | :heavy_check_mark:                                                                                                        | N/A                                                                                                                       | \{<br/>"disabled": false,<br/>"include_byok_in_limit": true,<br/>"limit": 75,<br/>"limit_reset": "daily",<br/>"name": "Updated API Key Name"<br/>} |
| `opts`                                                                                                                    | [][operations.Option](../../models/operations/option.mdx)                                                                  | :heavy_minus_sign:                                                                                                        | The options for this request.                                                                                             |                                                                                                                           |
