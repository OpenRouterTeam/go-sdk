...
```go
openResponsesResultToolUnion := components.CreateOpenResponsesResultToolUnionNamespace(components.NamespaceTool{/* values here */})
```
...
switch openResponsesResultToolUnion.Type {
	...
	case components.OpenResponsesResultToolUnionTypeNamespace:
		// openResponsesResultToolUnion.NamespaceTool is populated
	default:
