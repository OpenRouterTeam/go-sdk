...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `Parameters`                                                                          | [*components.FilesServerToolConfig](../../models/components/filesservertoolconfig.mdx) | ➖                                                                    | Configuration for the openrouter:files server tool                                    | \{}                                                                                    |
| `Type`                                                                                | [components.FilesServerToolType](../../models/components/filesservertooltype.mdx)      | ✅                                                                    | N/A                                                                                   |                                                                                       |