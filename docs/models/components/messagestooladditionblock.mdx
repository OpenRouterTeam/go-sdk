...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `Tool`                                                                                               | [components.MessagesToolAdditionBlockTool](../../models/components/messagestooladditionblocktool.mdx) | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
| `Type`                                                                                               | [components.TypeToolAddition](../../models/components/typetooladdition.mdx)                           | :heavy_check_mark:                                                                                   | N/A                                                                                                  |