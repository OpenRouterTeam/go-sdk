...
```go
outputItems := components.CreateOutputItemsOpenrouterFiles(components.OutputFilesServerToolItem{/* values here */})
```
...
```go
outputItems := components.CreateOutputItemsOpenrouterShell(components.OutputShellServerToolItem{/* values here */})
```
...
switch outputItems.Type {
	...
	case components.OutputItemsTypeOpenrouterFiles:
		// outputItems.OutputFilesServerToolItem is populated
	...
	case components.OutputItemsTypeOpenrouterShell:
		// outputItems.OutputShellServerToolItem is populated
