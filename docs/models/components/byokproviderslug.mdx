...
| `BYOKProviderSlugAmazonBedrockClaudeOnAws` | amazon-bedrock/claude-on-aws               |
| `BYOKProviderSlugAmazonNova`               | amazon-nova                                |
| `BYOKProviderSlugAmbient`                  | ambient                                    |
| `BYOKProviderSlugAnthropic`                | anthropic                                  |
| `BYOKProviderSlugAnthropic2`               | anthropic/2                                |
| `BYOKProviderSlugArceeAi`                  | arcee-ai                                   |
| `BYOKProviderSlugAssemblyai`               | assemblyai                                 |
...
| `BYOKProviderSlugClaudeOnAws`              | claude-on-aws                              |
| `BYOKProviderSlugCloudflare`               | cloudflare                                 |
| `BYOKProviderSlugCohere`                   | cohere                                     |
| `BYOKProviderSlugCoreweave`                | coreweave                                  |
| `BYOKProviderSlugCosine`                   | cosine                                     |
| `BYOKProviderSlugCrusoe`                   | crusoe                                     |
| `BYOKProviderSlugDarkbloom`                | darkbloom                                  |
| `BYOKProviderSlugDatabricks`               | databricks                                 |
| `BYOKProviderSlugDecart`                   | decart                                     |
| `BYOKProviderSlugDeepgram`                 | deepgram                                   |
...
| `BYOKProviderSlugFishAudio`                | fish-audio                                 |
...
| `BYOKProviderSlugNearAi`                   | near-ai                                    |
...
| `BYOKProviderSlugPrimeintellect`           | primeintellect                             |
| `BYOKProviderSlugQuiver`                   | quiver                                     |
| `BYOKProviderSlugRecraft`                  | recraft                                    |
| `BYOKProviderSlugReka`                     | reka                                       |
| `BYOKProviderSlugRelace`                   | relace                                     |
| `BYOKProviderSlugRespan`                   | respan                                     |
| `BYOKProviderSlugRunway`                   | runway                                     |
| `BYOKProviderSlugSailResearch`             | sail-research                              |
| `BYOKProviderSlugSakana`                   | sakana                                     |
| `BYOKProviderSlugSakanaAi`                 | sakana-ai                                  |
| `BYOKProviderSlugSambanova`                | sambanova                                  |
| `BYOKProviderSlugScaledown`                | scaledown                                  |
...
| `BYOKProviderSlugTencent`                  | tencent                                    |
| `BYOKProviderSlugTenstorrent`              | tenstorrent                                |
| `BYOKProviderSlugThinkingmachines`         | thinkingmachines                           |
| `BYOKProviderSlugTogether`                 | together                                   |
| `BYOKProviderSlugTypesafe`                 | typesafe                                   |
| `BYOKProviderSlugUnbiased`                 | unbiased                                   |
| `BYOKProviderSlugUpstage`                  | upstage                                    |
| `BYOKProviderSlugVenice`                   | venice                                     |
| `BYOKProviderSlugVoyageai`                 | voyageai                                   |
| `BYOKProviderSlugWafer`                    | wafer                                      |
| `BYOKProviderSlugWandb`                    | wandb                                      |
| `BYOKProviderSlugWandbLegacy`              | wandb-legacy                               |
