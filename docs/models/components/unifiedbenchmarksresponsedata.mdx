...
```go
unifiedBenchmarksResponseData := components.CreateUnifiedBenchmarksResponseDataOpenrouter(components.UnifiedBenchmarksORItem{/* values here */})
```
...
switch unifiedBenchmarksResponseData.Type {
	...
	case components.UnifiedBenchmarksResponseDataTypeOpenrouter:
