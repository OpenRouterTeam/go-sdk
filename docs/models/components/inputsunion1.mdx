...
```go
inputsUnion1 := components.CreateInputsUnion1OutputFilesServerToolItem(components.OutputFilesServerToolItem{/* values here */})
```

### OutputShellServerToolItem

```go
inputsUnion1 := components.CreateInputsUnion1OutputShellServerToolItem(components.OutputShellServerToolItem{/* values here */})
```
...
```go
inputsUnion1 := components.CreateInputsUnion1ContextCompactionItem(components.ContextCompactionItem{/* values here */})
```
...
```go
inputsUnion1 := components.CreateInputsUnion1AdditionalToolsItem(components.AdditionalToolsItem{/* values here */})
```

### AgentMessageItem

```go
inputsUnion1 := components.CreateInputsUnion1AgentMessageItem(components.AgentMessageItem{/* values here */})
```

### ConfigurationUpdateItem

```go
inputsUnion1 := components.CreateInputsUnion1ConfigurationUpdateItem(components.ConfigurationUpdateItem{/* values here */})
```
...
switch inputsUnion1.Type {
	...
	case components.InputsUnion1TypeOutputFilesServerToolItem:
		// inputsUnion1.OutputFilesServerToolItem is populated
	case components.InputsUnion1TypeOutputShellServerToolItem:
		// inputsUnion1.OutputShellServerToolItem is populated
	...
	case components.InputsUnion1TypeContextCompactionItem:
		// inputsUnion1.ContextCompactionItem is populated
	case components.InputsUnion1TypeItemReferenceItem:
		// inputsUnion1.ItemReferenceItem is populated
	case components.InputsUnion1TypeAdditionalToolsItem:
		// inputsUnion1.AdditionalToolsItem is populated
	case components.InputsUnion1TypeAgentMessageItem:
		// inputsUnion1.AgentMessageItem is populated
	case components.InputsUnion1TypeConfigurationUpdateItem:
		// inputsUnion1.ConfigurationUpdateItem is populated
}
```
