...
```go
responsesRequestPlugin := components.CreateResponsesRequestPluginAutoBetaRouter(components.AutoBetaRouterPlugin{/* values here */})
```
...
```go
responsesRequestPlugin := components.CreateResponsesRequestPluginSwitchyardRouter(components.SwitchyardRouterPlugin{/* values here */})
```
...
switch responsesRequestPlugin.Type {
	case components.ResponsesRequestPluginTypeAutoBetaRouter:
		// responsesRequestPlugin.AutoBetaRouterPlugin is populated
	...
	case components.ResponsesRequestPluginTypeSwitchyardRouter:
		// responsesRequestPlugin.SwitchyardRouterPlugin is populated
