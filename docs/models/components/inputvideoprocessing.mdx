...
value := components.InputVideoProcessingAgentic

// Open enum: custom values can be created with a direct type cast
custom := components.InputVideoProcessing("custom_value")
```
...
| Name                          | Value                         |
| ----------------------------- | ----------------------------- |
| `InputVideoProcessingAgentic` | agentic                       |
| `InputVideoProcessingStatic`  | static                        |