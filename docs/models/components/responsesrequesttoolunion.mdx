...
```go
responsesRequestToolUnion := components.CreateResponsesRequestToolUnionNamespace(components.NamespaceTool{/* values here */})
```
...
```go
responsesRequestToolUnion := components.CreateResponsesRequestToolUnionOpenrouterFiles(components.FilesServerTool{/* values here */})
```
...
```go
responsesRequestToolUnion := components.CreateResponsesRequestToolUnionOpenrouterExperimentalSearchModels(components.SearchModelsServerToolOpenRouter{/* values here */})
```
...
```go
responsesRequestToolUnion := components.CreateResponsesRequestToolUnionOpenrouterToolSearch(components.ToolSearchServerTool{/* values here */})
```
...
switch responsesRequestToolUnion.Type {
	...
	case components.ResponsesRequestToolUnionTypeNamespace:
		// responsesRequestToolUnion.NamespaceTool is populated
	...
	case components.ResponsesRequestToolUnionTypeOpenrouterFiles:
		// responsesRequestToolUnion.FilesServerTool is populated
	...
	case components.ResponsesRequestToolUnionTypeOpenrouterExperimentalSearchModels:
		// responsesRequestToolUnion.SearchModelsServerToolOpenRouter is populated
	...
	case components.ResponsesRequestToolUnionTypeOpenrouterToolSearch:
		// responsesRequestToolUnion.ToolSearchServerTool is populated
}
```
