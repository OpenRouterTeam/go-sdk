...
```go
messagesRequestToolUnion := components.CreateMessagesRequestToolUnionAnthropicToolSearchToolBm25(components.AnthropicToolSearchToolBm25{/* values here */})
```

### AnthropicToolSearchToolRegex

```go
messagesRequestToolUnion := components.CreateMessagesRequestToolUnionAnthropicToolSearchToolRegex(components.AnthropicToolSearchToolRegex{/* values here */})
```

### ShellServerToolOpenRouter

```go
messagesRequestToolUnion := components.CreateMessagesRequestToolUnionShellServerToolOpenRouter(components.ShellServerToolOpenRouter{/* values here */})
```

### ToolSearchServerTool

```go
messagesRequestToolUnion := components.CreateMessagesRequestToolUnionToolSearchServerTool(components.ToolSearchServerTool{/* values here */})
```
...
switch messagesRequestToolUnion.Type {
	...
	case components.MessagesRequestToolUnionTypeAnthropicToolSearchToolBm25:
		// messagesRequestToolUnion.AnthropicToolSearchToolBm25 is populated
	case components.MessagesRequestToolUnionTypeAnthropicToolSearchToolRegex:
		// messagesRequestToolUnion.AnthropicToolSearchToolRegex is populated
	case components.MessagesRequestToolUnionTypeShellServerToolOpenRouter:
		// messagesRequestToolUnion.ShellServerToolOpenRouter is populated
	case components.MessagesRequestToolUnionTypeToolSearchServerTool:
		// messagesRequestToolUnion.ToolSearchServerTool is populated
}
```
