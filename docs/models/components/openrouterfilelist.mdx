...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `Shape`                                                                                  | [components.OpenRouterFileListShape](../../models/components/openrouterfilelistshape.mdx) | :heavy_check_mark:                                                                       | N/A                                                                                      |
| `Cursor`                                                                                 | `*string`                                                                                | :heavy_check_mark:                                                                       | Opaque cursor for the next page; null when there are no more results.                    |
| `Data`                                                                                   | [][components.OpenRouterFile](../../models/components/openrouterfile.mdx)                 | :heavy_check_mark:                                                                       | N/A                                                                                      |
