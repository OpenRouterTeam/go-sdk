...
| `ImageGenerationRequestAspectRatioTwoDot351`                  | 2.35:1                                                        |
...
| `ImageGenerationRequestAspectRatioFiftyTwo`                   | 5:2                                                           |
| `ImageGenerationRequestAspectRatioFiftyFour`                  | 5:4                                                           |
| `ImageGenerationRequestAspectRatioFiftySeven`                 | 5:7                                                           |
| `ImageGenerationRequestAspectRatioSeventyFive`                | 7:5                                                           |
