...
| `ProviderResponseProviderNameAssemblyAi`          | AssemblyAI                                        |
...
| `ProviderResponseProviderNameClaudePlatformOnAws` | Claude Platform on AWS                            |
...
| `ProviderResponseProviderNameCoreWeave`           | CoreWeave                                         |
| `ProviderResponseProviderNameCosine`              | Cosine                                            |
...
| `ProviderResponseProviderNameDatabricks`          | Databricks                                        |
| `ProviderResponseProviderNameDecart`              | Decart                                            |
| `ProviderResponseProviderNameDeepgram`            | Deepgram                                          |
...
| `ProviderResponseProviderNameFishAudio`           | Fish Audio                                        |
...
| `ProviderResponseProviderNameMakora`              | Makora                                            |
...
| `ProviderResponseProviderNameVoyageAiByMongoDb`   | VoyageAI by MongoDB                               |
| `ProviderResponseProviderNameTypeSafe`            | TypeSafe                                          |
| `ProviderResponseProviderNameNearAi`              | Near AI                                           |
...
| `ProviderResponseProviderNameOllama`              | Ollama                                            |
...
| `ProviderResponseProviderNamePrimeIntellect`      | PrimeIntellect                                    |
...
| `ProviderResponseProviderNameRespan`              | Respan                                            |
| `ProviderResponseProviderNameSailResearch`        | Sail Research                                     |
| `ProviderResponseProviderNameSakanaAi`            | Sakana AI                                         |
| `ProviderResponseProviderNameSambaNova`           | SambaNova                                         |
| `ProviderResponseProviderNameScaleDown`           | ScaleDown                                         |
...
| `ProviderResponseProviderNameTencent`             | Tencent                                           |
| `ProviderResponseProviderNameTenstorrent`         | Tenstorrent                                       |
| `ProviderResponseProviderNameThinkingMachines`    | Thinking Machines                                 |
| `ProviderResponseProviderNameTogether`            | Together                                          |
| `ProviderResponseProviderNameUnbiased`            | Unbiased                                          |
...
| `ProviderResponseProviderNameKrea`                | Krea                                              |
| `ProviderResponseProviderNameRunway`              | Runway                                            |
