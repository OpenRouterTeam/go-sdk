...
value := components.SupportedSizeThreeHundredAndSixtyx360
...
| Name                                                   | Value                                                  |
| ------------------------------------------------------ | ------------------------------------------------------ |
| `SupportedSizeThreeHundredAndSixtyx360`                | 360x360                                                |
| `SupportedSizeThreeHundredAndSixtyx480`                | 360x480                                                |
| `SupportedSizeThreeHundredAndSixtyx540`                | 360x540                                                |
| `SupportedSizeThreeHundredAndSixtyx640`                | 360x640                                                |
| `SupportedSizeThreeHundredAndSixtyx840`                | 360x840                                                |
| `SupportedSizeFourHundredAndEightyx360`                | 480x360                                                |
...
| `SupportedSizeFiveHundredAndFortyx360`                 | 540x360                                                |
| `SupportedSizeFiveHundredAndSixtyx752`                 | 560x752                                                |
| `SupportedSizeSixHundredAndFortyx360`                  | 640x360                                                |
| `SupportedSizeSixHundredAndFortyx480`                  | 640x480                                                |
| `SupportedSizeSixHundredAndFortyx640`                  | 640x640                                                |
...
| `SupportedSizeSevenHundredAndFiftyTwox560`             | 752x560                                                |
...
| `SupportedSizeEightHundredAndThirtyFourx1112`          | 834x1112                                               |
| `SupportedSizeEightHundredAndFortyx360`                | 840x360                                                |
| `SupportedSizeEightHundredAndFiftyFourx480`            | 854x480                                                |
| `SupportedSizeNineHundredAndSixtyx720`                 | 960x720                                                |
| `SupportedSizeNineHundredAndSixtyx960`                 | 960x960                                                |
| `SupportedSizeNineHundredAndNinetyTwox432`             | 992x432                                                |
...
| `SupportedSizeOneThousandOneHundredAndTwelvex834`      | 1112x834                                               |
...
| `SupportedSizeOneThousandFourHundredAndSeventyx630`    | 1470x630                                               |
