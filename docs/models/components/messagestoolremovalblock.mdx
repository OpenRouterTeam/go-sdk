...
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `Tool`                                                                                             | [components.MessagesToolRemovalBlockTool](../../models/components/messagestoolremovalblocktool.mdx) | :heavy_check_mark:                                                                                 | N/A                                                                                                |
| `Type`                                                                                             | [components.TypeToolRemoval](../../models/components/typetoolremoval.mdx)                           | :heavy_check_mark:                                                                                 | N/A                                                                                                |