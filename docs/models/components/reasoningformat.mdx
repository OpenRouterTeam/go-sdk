...
| `ReasoningFormatBedrockOpenaiResponsesV1` | bedrock-openai-responses-v1               |
| `ReasoningFormatBedrockXaiResponsesV1`    | bedrock-xai-responses-v1                  |
| `ReasoningFormatXaiResponsesV1`           | xai-responses-v1                          |
| `ReasoningFormatMetaResponsesV1`          | meta-responses-v1                         |
