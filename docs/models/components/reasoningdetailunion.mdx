...
```go
reasoningDetailUnion := components.CreateReasoningDetailUnionReasoningServerToolCall(components.ReasoningDetailServerToolCall{/* values here */})
```
...
switch reasoningDetailUnion.Type {
	...
	case components.ReasoningDetailUnionTypeReasoningServerToolCall:
		// reasoningDetailUnion.ReasoningDetailServerToolCall is populated
