...
value := components.ProviderNameModal
...
| `ProviderNameAssemblyAi`          | AssemblyAI                        |
...
| `ProviderNameFishAudio`           | Fish Audio                        |
...
| `ProviderNameVoyageAiByMongoDb`   | VoyageAI by MongoDB               |
| `ProviderNameTypeSafe`            | TypeSafe                          |
| `ProviderNameNearAi`              | Near AI                           |
...
| `ProviderNamePrimeIntellect`      | PrimeIntellect                    |
...
| `ProviderNameRespan`              | Respan                            |
| `ProviderNameSailResearch`        | Sail Research                     |
| `ProviderNameSakanaAi`            | Sakana AI                         |
| `ProviderNameSambaNova`           | SambaNova                         |
| `ProviderNameScaleDown`           | ScaleDown                         |
...
| `ProviderNameThinkingMachines`    | Thinking Machines                 |
| `ProviderNameTogether`            | Together                          |
| `ProviderNameUnbiased`            | Unbiased                          |
...
| `ProviderNameKrea`                | Krea                              |
| `ProviderNameRunway`              | Runway                            |
