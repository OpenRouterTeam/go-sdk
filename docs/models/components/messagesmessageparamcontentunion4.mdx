...
```go
messagesMessageParamContentUnion4 := components.CreateMessagesMessageParamContentUnion4ToolAddition(components.MessagesToolAdditionBlock{/* values here */})
```

### MessagesToolRemovalBlock

```go
messagesMessageParamContentUnion4 := components.CreateMessagesMessageParamContentUnion4ToolRemoval(components.MessagesToolRemovalBlock{/* values here */})
```

### MessagesShellToolResultBlock

```go
messagesMessageParamContentUnion4 := components.CreateMessagesMessageParamContentUnion4OpenrouterShellToolResult(components.MessagesShellToolResultBlock{/* values here */})
```

### MessagesBashToolResultBlock

```go
messagesMessageParamContentUnion4 := components.CreateMessagesMessageParamContentUnion4OpenrouterBashToolResult(components.MessagesBashToolResultBlock{/* values here */})
```
...
switch messagesMessageParamContentUnion4.Type {
	...
	case components.MessagesMessageParamContentUnion4TypeToolAddition:
		// messagesMessageParamContentUnion4.MessagesToolAdditionBlock is populated
	case components.MessagesMessageParamContentUnion4TypeToolRemoval:
		// messagesMessageParamContentUnion4.MessagesToolRemovalBlock is populated
	case components.MessagesMessageParamContentUnion4TypeOpenrouterShellToolResult:
		// messagesMessageParamContentUnion4.MessagesShellToolResultBlock is populated
	case components.MessagesMessageParamContentUnion4TypeOpenrouterBashToolResult:
		// messagesMessageParamContentUnion4.MessagesBashToolResultBlock is populated
}
```
