...
```go
baseInputsUnion1 := components.CreateBaseInputsUnion1ConfigurationUpdateItem(components.ConfigurationUpdateItem{/* values here */})
```
...
switch baseInputsUnion1.Type {
	...
	case components.BaseInputsUnion1TypeConfigurationUpdateItem:
		// baseInputsUnion1.ConfigurationUpdateItem is populated
}
```
