...
| `ProviderAmazonBedrockClaudeOnAws` | amazon-bedrock/claude-on-aws       |
| `ProviderAmazonNova`               | amazon-nova                        |
| `ProviderAmbient`                  | ambient                            |
| `ProviderAnthropic`                | anthropic                          |
| `ProviderAnthropic2`               | anthropic/2                        |
...
| `ProviderClaudeOnAws`              | claude-on-aws                      |
| `ProviderCloudflare`               | cloudflare                         |
| `ProviderCohere`                   | cohere                             |
| `ProviderCoreweave`                | coreweave                          |
| `ProviderCosine`                   | cosine                             |
...
| `ProviderThinkingmachines`         | thinkingmachines                   |
| `ProviderTogether`                 | together                           |
| `ProviderTypesafe`                 | typesafe                           |
| `ProviderUnbiased`                 | unbiased                           |
| `ProviderUpstage`                  | upstage                            |
| `ProviderVenice`                   | venice                             |
| `ProviderVoyageai`                 | voyageai                           |
| `ProviderWafer`                    | wafer                              |
| `ProviderWandb`                    | wandb                              |
| `ProviderWandbLegacy`              | wandb-legacy                       |
| `ProviderXai`                      | xai                                |
