...
func (l *ListScimGroupMappingsRequest) GetOffset() optionalnullable.OptionalNullable[int64] {
	if l == nil {
		return nil
	}
	return l.Offset
...
func (l *ListScimGroupMappingsResponse) GetResult() components.ListScimGroupMappingsResponse {
	if l == nil {
		return components.ListScimGroupMappingsResponse{}
	}
	return l.Result
}
