...
type OpenResponsesRequestToolUnion struct {
	OpenResponsesRequestToolFunction          *OpenResponsesRequestToolFunction          `queryParam:"inline,name=tool" union:"member"`
	OpenResponsesWebSearchPreviewTool         *OpenResponsesWebSearchPreviewTool         `queryParam:"inline,name=tool" union:"member"`
	OpenResponsesWebSearchPreview20250311Tool *OpenResponsesWebSearchPreview20250311Tool `queryParam:"inline,name=tool" union:"member"`
	OpenResponsesWebSearchTool                *OpenResponsesWebSearchTool                `queryParam:"inline,name=tool" union:"member"`
	OpenResponsesWebSearch20250826Tool        *OpenResponsesWebSearch20250826Tool        `queryParam:"inline,name=tool" union:"member"`
...
type OpenResponsesRequestSort struct {
	ProviderSort       *ProviderSort       `queryParam:"inline,name=sort" union:"member"`
	ProviderSortConfig *ProviderSortConfig `queryParam:"inline,name=sort" union:"member"`
	Any                any                 `queryParam:"inline,name=sort" union:"member"`
...
type OpenResponsesRequestPluginUnion struct {
	OpenResponsesRequestPluginAutoRouter      *OpenResponsesRequestPluginAutoRouter      `queryParam:"inline,name=plugin" union:"member"`
	OpenResponsesRequestPluginModeration      *OpenResponsesRequestPluginModeration      `queryParam:"inline,name=plugin" union:"member"`
	OpenResponsesRequestPluginWeb             *OpenResponsesRequestPluginWeb             `queryParam:"inline,name=plugin" union:"member"`
	OpenResponsesRequestPluginFileParser      *OpenResponsesRequestPluginFileParser      `queryParam:"inline,name=plugin" union:"member"`
	OpenResponsesRequestPluginResponseHealing *OpenResponsesRequestPluginResponseHealing `queryParam:"inline,name=plugin" union:"member"`
