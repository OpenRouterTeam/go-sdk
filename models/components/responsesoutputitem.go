...
type ResponsesOutputItem struct {
	ResponsesOutputMessage            *ResponsesOutputMessage            `queryParam:"inline,name=ResponsesOutputItem" union:"member"`
	ResponsesOutputItemReasoning      *ResponsesOutputItemReasoning      `queryParam:"inline,name=ResponsesOutputItem" union:"member"`
	ResponsesOutputItemFunctionCall   *ResponsesOutputItemFunctionCall   `queryParam:"inline,name=ResponsesOutputItem" union:"member"`
	ResponsesWebSearchCallOutput      *ResponsesWebSearchCallOutput      `queryParam:"inline,name=ResponsesOutputItem" union:"member"`
	ResponsesOutputItemFileSearchCall *ResponsesOutputItemFileSearchCall `queryParam:"inline,name=ResponsesOutputItem" union:"member"`
	ResponsesImageGenerationCall      *ResponsesImageGenerationCall      `queryParam:"inline,name=ResponsesOutputItem" union:"member"`
