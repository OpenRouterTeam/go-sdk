...
type ProviderSortUnion struct {
	ProviderSort       *ProviderSort       `queryParam:"inline,name=ProviderSortUnion" union:"member"`
	ProviderSortConfig *ProviderSortConfig `queryParam:"inline,name=ProviderSortUnion" union:"member"`
