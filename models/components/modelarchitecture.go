...
type ModelArchitecture struct {
	...
	InstructType optionalnullable.OptionalNullable[InstructType] `json:"instruct_type,omitzero"`
...
func (m *ModelArchitecture) GetInstructType() optionalnullable.OptionalNullable[InstructType] {
	if m == nil {
		return nil
	}
