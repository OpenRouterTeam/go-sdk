...
type ResponsesOutputItemReasoningStatusUnion struct {
	ResponsesOutputItemReasoningStatusCompleted  *ResponsesOutputItemReasoningStatusCompleted  `queryParam:"inline,name=status" union:"member"`
	ResponsesOutputItemReasoningStatusIncomplete *ResponsesOutputItemReasoningStatusIncomplete `queryParam:"inline,name=status" union:"member"`
	ResponsesOutputItemReasoningStatusInProgress *ResponsesOutputItemReasoningStatusInProgress `queryParam:"inline,name=status" union:"member"`
