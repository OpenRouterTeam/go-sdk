...
type OpenResponsesReasoningStatusUnion struct {
	OpenResponsesReasoningStatusCompleted  *OpenResponsesReasoningStatusCompleted  `queryParam:"inline,name=status" union:"member"`
	OpenResponsesReasoningStatusIncomplete *OpenResponsesReasoningStatusIncomplete `queryParam:"inline,name=status" union:"member"`
	OpenResponsesReasoningStatusInProgress *OpenResponsesReasoningStatusInProgress `queryParam:"inline,name=status" union:"member"`
