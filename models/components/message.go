...
type MessageContent struct {
	...
	ArrayOfChatMessageContentItemText []ChatMessageContentItemText `queryParam:"inline,name=content" union:"member"`
...
type Message struct {
	SystemMessage       *SystemMessage       `queryParam:"inline,name=Message" union:"member"`
	UserMessage         *UserMessage         `queryParam:"inline,name=Message" union:"member"`
	MessageDeveloper    *MessageDeveloper    `queryParam:"inline,name=Message" union:"member"`
	AssistantMessage    *AssistantMessage    `queryParam:"inline,name=Message" union:"member"`
	ToolResponseMessage *ToolResponseMessage `queryParam:"inline,name=Message" union:"member"`
