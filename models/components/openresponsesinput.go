...
type OpenResponsesInput1 struct {
	OpenResponsesReasoning            *OpenResponsesReasoning            `queryParam:"inline,name=" union:"member"`
	OpenResponsesEasyInputMessage     *OpenResponsesEasyInputMessage     `queryParam:"inline,name=" union:"member"`
	OpenResponsesInputMessageItem     *OpenResponsesInputMessageItem     `queryParam:"inline,name=" union:"member"`
	OpenResponsesFunctionToolCall     *OpenResponsesFunctionToolCall     `queryParam:"inline,name=" union:"member"`
	OpenResponsesFunctionCallOutput   *OpenResponsesFunctionCallOutput   `queryParam:"inline,name=" union:"member"`
	ResponsesOutputMessage            *ResponsesOutputMessage            `queryParam:"inline,name=" union:"member"`
	ResponsesOutputItemReasoning      *ResponsesOutputItemReasoning      `queryParam:"inline,name=" union:"member"`
	ResponsesOutputItemFunctionCall   *ResponsesOutputItemFunctionCall   `queryParam:"inline,name=" union:"member"`
	ResponsesWebSearchCallOutput      *ResponsesWebSearchCallOutput      `queryParam:"inline,name=" union:"member"`
	ResponsesOutputItemFileSearchCall *ResponsesOutputItemFileSearchCall `queryParam:"inline,name=" union:"member"`
	ResponsesImageGenerationCall      *ResponsesImageGenerationCall      `queryParam:"inline,name=" union:"member"`
...
type OpenResponsesInput struct {
	Str                        *string               `queryParam:"inline,name=OpenResponsesInput" union:"member"`
	ArrayOfOpenResponsesInput1 []OpenResponsesInput1 `queryParam:"inline,name=OpenResponsesInput" union:"member"`
