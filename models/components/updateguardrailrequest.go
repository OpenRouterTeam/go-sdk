...
func (u *UpdateGuardrailRequest) GetAllowedDataRegions() optionalnullable.OptionalNullable[[]GuardrailDataRegion] {
	if u == nil {
		return nil
	}
...
func (u *UpdateGuardrailRequest) GetContentFilterBuiltins() optionalnullable.OptionalNullable[[]ContentFilterBuiltinEntryInput] {
	if u == nil {
		return nil
	}
