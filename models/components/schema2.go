...
type Schema2 struct {
	Schema2ReasoningSummary   *Schema2ReasoningSummary   `queryParam:"inline,name=_schema2" union:"member"`
	Schema2ReasoningEncrypted *Schema2ReasoningEncrypted `queryParam:"inline,name=_schema2" union:"member"`
	Schema2ReasoningText      *Schema2ReasoningText      `queryParam:"inline,name=_schema2" union:"member"`
