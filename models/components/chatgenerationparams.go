...
type ChatGenerationParamsPreferredMinThroughputUnion struct {
	Number                                     *float64                                    `queryParam:"inline,name=preferred_min_throughput" union:"member"`
	ChatGenerationParamsPreferredMinThroughput *ChatGenerationParamsPreferredMinThroughput `queryParam:"inline,name=preferred_min_throughput" union:"member"`
...
type ChatGenerationParamsPreferredMaxLatencyUnion struct {
	Number                                  *float64                                 `queryParam:"inline,name=preferred_max_latency" union:"member"`
	ChatGenerationParamsPreferredMaxLatency *ChatGenerationParamsPreferredMaxLatency `queryParam:"inline,name=preferred_max_latency" union:"member"`
...
type ChatGenerationParamsPluginUnion struct {
	ChatGenerationParamsPluginAutoRouter      *ChatGenerationParamsPluginAutoRouter      `queryParam:"inline,name=plugin" union:"member"`
	ChatGenerationParamsPluginModeration      *ChatGenerationParamsPluginModeration      `queryParam:"inline,name=plugin" union:"member"`
	ChatGenerationParamsPluginWeb             *ChatGenerationParamsPluginWeb             `queryParam:"inline,name=plugin" union:"member"`
	ChatGenerationParamsPluginFileParser      *ChatGenerationParamsPluginFileParser      `queryParam:"inline,name=plugin" union:"member"`
	ChatGenerationParamsPluginResponseHealing *ChatGenerationParamsPluginResponseHealing `queryParam:"inline,name=plugin" union:"member"`
...
type ResponseFormatPython struct {
	type_ string `const:"python" json:"type"`
}

func (r ResponseFormatPython) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(r, "", false)
}

func (r *ResponseFormatPython) UnmarshalJSON(data []byte) error {
...
func (r *ResponseFormatPython) GetType() string {
	return "python"
}
...
func (r *ResponseFormatJSONObject) GetType() string {
	return "json_object"
}
...
func (r *ResponseFormatText) GetType() string {
	return "text"
}
...
type ResponseFormat struct {
	ResponseFormatText        *ResponseFormatText        `queryParam:"inline,name=response_format" union:"member"`
	ResponseFormatJSONObject  *ResponseFormatJSONObject  `queryParam:"inline,name=response_format" union:"member"`
	ResponseFormatJSONSchema  *ResponseFormatJSONSchema  `queryParam:"inline,name=response_format" union:"member"`
	ResponseFormatTextGrammar *ResponseFormatTextGrammar `queryParam:"inline,name=response_format" union:"member"`
	ResponseFormatPython      *ResponseFormatPython      `queryParam:"inline,name=response_format" union:"member"`

	Type ResponseFormatType
}

func CreateResponseFormatText(text ResponseFormatText) ResponseFormat {
...
func CreateResponseFormatJSONObject(jsonObject ResponseFormatJSONObject) ResponseFormat {
...
func CreateResponseFormatJSONSchema(jsonSchema ResponseFormatJSONSchema) ResponseFormat {
...
func CreateResponseFormatGrammar(grammar ResponseFormatTextGrammar) ResponseFormat {
...
func CreateResponseFormatPython(python ResponseFormatPython) ResponseFormat {
	typ := ResponseFormatTypePython

	return ResponseFormat{
		ResponseFormatPython: &python,
		Type:                 typ,
	}
}
...
func (u *ResponseFormat) UnmarshalJSON(data []byte) error {
	...
	switch dis.Type {
	case "text":
		responseFormatText := new(ResponseFormatText)
		if err := utils.UnmarshalJSON(data, &responseFormatText, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == text) type ResponseFormatText within ResponseFormat: %w", string(data), err)
		}
		...
		return nil
	case "json_object":
		responseFormatJSONObject := new(ResponseFormatJSONObject)
		if err := utils.UnmarshalJSON(data, &responseFormatJSONObject, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == json_object) type ResponseFormatJSONObject within ResponseFormat: %w", string(data), err)
		}
	...
	case "json_schema":
		...
		if err := utils.UnmarshalJSON(data, &responseFormatJSONSchema, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == json_schema) type ResponseFormatJSONSchema within ResponseFormat: %w", string(data), err)
		}
	...
	case "grammar":
		...
		if err := utils.UnmarshalJSON(data, &responseFormatTextGrammar, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == grammar) type ResponseFormatTextGrammar within ResponseFormat: %w", string(data), err)
		}
		...
		return nil
	case "python":
		responseFormatPython := new(ResponseFormatPython)
		if err := utils.UnmarshalJSON(data, &responseFormatPython, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == python) type ResponseFormatPython within ResponseFormat: %w", string(data), err)
		}

		u.ResponseFormatPython = responseFormatPython
...
func (u ResponseFormat) MarshalJSON() ([]byte, error) {
	...
	if u.ResponseFormatPython != nil {
		return utils.MarshalJSON(u.ResponseFormatPython, "", true)
	}
...
type Stop struct {
	Str        *string  `queryParam:"inline,name=stop" union:"member"`
	ArrayOfStr []string `queryParam:"inline,name=stop" union:"member"`
...
type ChatGenerationParamsImageConfig struct {
	Str    *string  `queryParam:"inline,name=image_config" union:"member"`
	Number *float64 `queryParam:"inline,name=image_config" union:"member"`
...
func (c *ChatGenerationParams) GetResponseFormat() *ResponseFormat {
	if c == nil {
		return nil
	}
...
func (c *ChatGenerationParams) GetResponseFormatText() *ResponseFormatText {
	if v := c.GetResponseFormat(); v != nil {
		return v.ResponseFormatText
	}
	return nil
}

func (c *ChatGenerationParams) GetResponseFormatJSONObject() *ResponseFormatJSONObject {
	if v := c.GetResponseFormat(); v != nil {
		return v.ResponseFormatJSONObject
	}
	return nil
}
...
func (c *ChatGenerationParams) GetResponseFormatPython() *ResponseFormatPython {
	if v := c.GetResponseFormat(); v != nil {
		return v.ResponseFormatPython
	}
	return nil
}
...
func (c *ChatGenerationParams) GetStop() optionalnullable.OptionalNullable[Stop] {
	if c == nil {
		return nil
	}
	return c.Stop
