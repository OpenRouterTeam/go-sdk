...
type OpenResponsesInputMessageItemRoleUnion struct {
	OpenResponsesInputMessageItemRoleUser      *OpenResponsesInputMessageItemRoleUser      `queryParam:"inline,name=role" union:"member"`
	OpenResponsesInputMessageItemRoleSystem    *OpenResponsesInputMessageItemRoleSystem    `queryParam:"inline,name=role" union:"member"`
	OpenResponsesInputMessageItemRoleDeveloper *OpenResponsesInputMessageItemRoleDeveloper `queryParam:"inline,name=role" union:"member"`
...
type OpenResponsesInputMessageItemContentUnion struct {
	...
	OpenResponsesInputMessageItemContentInputImage *OpenResponsesInputMessageItemContentInputImage `queryParam:"inline,name=content" union:"member"`
	...
	ResponseInputVideo                             *ResponseInputVideo                             `queryParam:"inline,name=content" union:"member"`
