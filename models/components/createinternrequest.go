...
func (c *CreateInternRequest) GetDescription() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
...
func (c *CreateInternRequest) GetInstructions() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
