...
type ChatResultObject string

const (
	ChatResultObjectChatCompletion ChatResultObject = "chat.completion"
)

func (e ChatResultObject) ToPointer() *ChatResultObject {
	return &e
}
func (e *ChatResultObject) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "chat.completion":
		*e = ChatResultObject(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ChatResultObject: %v", v)
	}
}
...
func (c *ChatResult) GetObject() ChatResultObject {
	if c == nil {
		return ChatResultObject("")
	}
	return c.Object
}
