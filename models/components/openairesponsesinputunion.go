...
type OpenAIResponsesInputRoleUnion2 struct {
	OpenAIResponsesInputRoleUser2      *OpenAIResponsesInputRoleUser2      `queryParam:"inline,name=role" union:"member"`
	OpenAIResponsesInputRoleSystem2    *OpenAIResponsesInputRoleSystem2    `queryParam:"inline,name=role" union:"member"`
	OpenAIResponsesInputRoleDeveloper2 *OpenAIResponsesInputRoleDeveloper2 `queryParam:"inline,name=role" union:"member"`
...
type OpenAIResponsesInputContent3 struct {
	ResponseInputText  *ResponseInputText  `queryParam:"inline,name=content" union:"member"`
	ResponseInputImage *ResponseInputImage `queryParam:"inline,name=content" union:"member"`
	ResponseInputFile  *ResponseInputFile  `queryParam:"inline,name=content" union:"member"`
	ResponseInputAudio *ResponseInputAudio `queryParam:"inline,name=content" union:"member"`
...
type OpenAIResponsesInputRoleUnion1 struct {
	OpenAIResponsesInputRoleUser1      *OpenAIResponsesInputRoleUser1      `queryParam:"inline,name=role" union:"member"`
	OpenAIResponsesInputRoleSystem1    *OpenAIResponsesInputRoleSystem1    `queryParam:"inline,name=role" union:"member"`
	OpenAIResponsesInputRoleAssistant  *OpenAIResponsesInputRoleAssistant  `queryParam:"inline,name=role" union:"member"`
	OpenAIResponsesInputRoleDeveloper1 *OpenAIResponsesInputRoleDeveloper1 `queryParam:"inline,name=role" union:"member"`
...
type OpenAIResponsesInputContent1 struct {
	ResponseInputText  *ResponseInputText  `queryParam:"inline,name=" union:"member"`
	ResponseInputImage *ResponseInputImage `queryParam:"inline,name=" union:"member"`
	ResponseInputFile  *ResponseInputFile  `queryParam:"inline,name=" union:"member"`
	ResponseInputAudio *ResponseInputAudio `queryParam:"inline,name=" union:"member"`
...
type OpenAIResponsesInputContent2 struct {
	ArrayOfOpenAIResponsesInputContent1 []OpenAIResponsesInputContent1 `queryParam:"inline,name=content" union:"member"`
	Str                                 *string                        `queryParam:"inline,name=content" union:"member"`
...
type OpenAIResponsesInputUnion1 struct {
	OpenAIResponsesInputMessage1           *OpenAIResponsesInputMessage1           `queryParam:"inline,name=" union:"member"`
	OpenAIResponsesInputMessage2           *OpenAIResponsesInputMessage2           `queryParam:"inline,name=" union:"member"`
	OpenAIResponsesInputFunctionCallOutput *OpenAIResponsesInputFunctionCallOutput `queryParam:"inline,name=" union:"member"`
	OpenAIResponsesInputFunctionCall       *OpenAIResponsesInputFunctionCall       `queryParam:"inline,name=" union:"member"`
	OutputItemImageGenerationCall          *OutputItemImageGenerationCall          `queryParam:"inline,name=" union:"member"`
	OutputMessage                          *OutputMessage                          `queryParam:"inline,name=" union:"member"`
...
type OpenAIResponsesInputUnion struct {
	Str                               *string                      `queryParam:"inline,name=OpenAIResponsesInput" union:"member"`
	ArrayOfOpenAIResponsesInputUnion1 []OpenAIResponsesInputUnion1 `queryParam:"inline,name=OpenAIResponsesInput" union:"member"`
	Any                               any                          `queryParam:"inline,name=OpenAIResponsesInput" union:"member"`
